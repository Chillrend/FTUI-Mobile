...
public class SemuaAduanController {

    SemuaAduanFragment fragment;
    ListPendingPostAdapter adapter;
    ArrayList<ListPendingPostModel> data = new ArrayList<>();

    public SemuaAduanController(SemuaAduanFragment fragment) {
    ...
    public void onPendingPostDataRequest(){
        new TimelineRequest(fragment.getContext()).requestAllKeluhan(new ListPendingPostCallBack() {
            @Override
    ...
    private void onPendingRequestMoreData(){
        new TimelineRequest(fragment.getContext()).requestAllCompleteLoadMore(new ListPendingPostCallBack() {
            @Override
            public void onDataSetResutl(ArrayList<ListPendingPostModel> response) {
                data.addAll(response);
                adapter.notifyDataSetChanged();
