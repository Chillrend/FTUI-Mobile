...
public class ManagerController {
    ...
    public ManagerController(ManagerFragment fragment) {
    ...
    public void onPendingPostDataRequest(){
        new TimelineRequest(fragment.getContext()).requestPendingPost(new ListPendingPostCallBack() {
            @Override
            public void onDataSetResutl(ArrayList<ListPendingPostModel> response) {
                ...
                fragment.getTvTidakAdaData().setVisibility(View.GONE);
            }
    ...
    private void onPendingRequestMoreData(){
        new TimelineRequest(fragment.getContext()).requestPendingPostLoadMore(new ListPendingPostCallBack() {
            @Override
            public void onDataSetResutl(ArrayList<ListPendingPostModel> response) {
                data.addAll(response);
                adapter.notifyDataSetChanged();
    ...
    private void updateStatus(){
        new TimelineRequest(fragment.getContext()).updatePost(new LoginCallBack() {
            ...
            public void onRequestSuccess(String response) {
                ...
                ((MenuActivity)fragment.getContext()).getMenuName().setText("Manager");
                alertDialog.dismiss();
            }
