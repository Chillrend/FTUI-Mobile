...
import com.rsypj.ftuimobile.ui.fragment.controller.SemuaAduanController;

public class SemuaAduanFragment extends SmartSipBaseFragment implements SwipeRefreshLayout.OnRefreshListener{

    LinearLayout llLoadMore;
    TextView tvLoadMore;
    RecyclerView listPost;
    SwipeRefreshLayout swipeRefreshLayout;
    SemuaAduanController controller;
    ...
    public void initItem(View v) {
        ...
        controller = new SemuaAduanController(this);
    }
